...
import resume from '../assets/Md Arefine Ahamed Joy Resume.pdf'
const Footer = () => {
  return (
    <div className="pt-10">
      <footer className=" py-10 bg-neutral px-4 md:px-0   md:flex md:pt-20 ">
        <div className=" md:w-3/12 md:text-center">
          <span className="footer-title text-2xl text-[#d2a668] font-signature font-bold shadow-md shadow-white">
            Arefine29
          </span>
        </div>
        ...
        <div className=" md:w-3/12 text-right pe-5">
          <a href={resume} download="Md Arefine Ahamed Joy Resume">
          <button
            className=" block px-8 py-2 hover:bg-[#ffc576] hover:text-black font-medium outline   duration-700 outline-[#ffc576] d"
            data-aos="flip-left"
